from sqlalchemy import Column, Integer, String, Float, Numeric, Date, DateTime, Text, ForeignKey, func, Index, JSON
...
class ExerciseRecord(Base):
    ...
    notes = Column(Text)
    distance_km = Column(Numeric(5, 2), nullable=True, comment="运动距离(公里)，适用于跑步/骑行/游泳/步行")
