...
class PetAvatar(Base):
    ...
    base_image_url = Column(String(500), nullable=True)
    emotion_happy_url = Column(String(500), nullable=True)
    emotion_normal_url = Column(String(500), nullable=True)
    emotion_hungry_url = Column(String(500), nullable=True)
    emotion_weak_url = Column(String(500), nullable=True)
