...
class AppColors {
  ...
  static const Color lateNightStart = Color(0xFF6B46C1); // 夜宵渐变起（与历史页夜宵紫一致）
  static const Color lateNightEnd = Color(0xFF9F7AEA); // 夜宵渐变止
  ...
  static const LinearGradient lateNightGradient = LinearGradient(
    colors: [lateNightStart, lateNightEnd],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
  ...
  // 状态颜色辅助方法
  static Color getStateColor(bool isActive,
