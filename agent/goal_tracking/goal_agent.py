...
from agent.goal_tracking.nodes import (
    ...
    calculate_fasting_targets_node,
...
goal_workflow.add_node("calculate_fasting_targets", calculate_fasting_targets_node)
...
goal_workflow.add_edge("calculate_daily_targets", "calculate_fasting_targets")
goal_workflow.add_edge("calculate_fasting_targets", "track_today_progress")
